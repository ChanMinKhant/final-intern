...
@section('content')
    ...
    <div class="container">
        <h3 class="page-title text-center" style="padding-top: 30px; padding-bottom: 10px;">
            <strong><b>ရုပ်ပုံများနှင့် ဗီဒီယိုများ</b></strong>
        </h3> <br>
        <p class="text-center mb-5 lead">"ရုပ်ပုံများနှင့် ဗီဒီယိုများမှတစ်ဆင့် ကျွန်ုပ်တို့၏ နွားမွေးမြူရေးခြံ၏ အလှကို
            ရှာဖွေပါ။"</p>
    </div>
    <br>
    ...
    <div class="container mt-3">
        ...
        <div class="row mb-5">
            <div class="text-center mb-4">
                ...
                <h3 class="category-title">ရုပ်ပုံများ</h3>
            </div>
        ...
        <div class="row mb-5">
            <div class="col-12 text-center mb-4">
                <h3 class="category-title">အိမ်ရာနှင့် အထောက်အပံ့ပစ္စည်းများ</h3>
            </div>
            <!-- First row -->
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card">
        ...
        <div class="row mb-5">
            <div class="col-12 text-center mb-4">
                <h3 class="category-title">ဗီဒီယိုများ</h3>
            </div>
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card">
